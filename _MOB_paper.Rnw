...
<<eval = TRUE, echo = FALSE, fig=TRUE, width=5, height=5>>=
library("colorspace")
set.seed(3)
...
points(x = 1, y = mean(toy_data$y), col = rainbow_hcl(1), pch = 17)
@
\end{subfigure}
\label{fig:global}
\end{figure}
